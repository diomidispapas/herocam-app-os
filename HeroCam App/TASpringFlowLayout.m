...
#import "TASpringFlowLayout.h"

@interface TASpringFlowLayout ()
...
@implementation TASpringFlowLayout {
}
...
- (void)prepareLayout
{
    ...
    [newlyVisibleItems enumerateObjectsUsingBlock:^(UICollectionViewLayoutAttributes *item, NSUInteger idx, BOOL *stop) {
        ...
        springBehaviour.length = 1.f;
        springBehaviour.damping = 0.5f;
        springBehaviour.frequency = 0.8f;
        CGFloat staticCenterX = item.frame.origin.x + item.frame.size.width / 2;
...
- (void)prepareForCollectionViewUpdates:(NSArray *)updateItems
{
    ...
    [updateItems enumerateObjectsUsingBlock:^(UICollectionViewUpdateItem *updateItem, NSUInteger idx, BOOL *stop) {
        if (updateItem.updateAction == UICollectionUpdateActionInsert) {
            ...
            springBehaviour.damping = 0.5f;
            springBehaviour.frequency = 0.8f;
            CGFloat staticCenterX = attributes.frame.origin.x + attributes.frame.size.width / 2;
            springBehaviour.action = ^{
